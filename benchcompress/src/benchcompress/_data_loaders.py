...
def load_real_000876(
    *, num_samples: int, num_channels: int, start_channel: int
    ...
    """
    warnings.warn(
        "This function is deprecated. Use datasets['real-000876-ch45']['create']() instead.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def load_real_000409(
    *, num_samples: int, num_channels: int, start_channel: int
    ...
    """
    warnings.warn(
        "This function is deprecated. Use datasets['real-000409-ch101']['create']() instead.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def load_real_001290(
    *, num_samples: int, num_channels: int, start_channel: int
    ...
    """
    warnings.warn(
        "This function is deprecated. Use datasets['real-001290-ch0']['create']() instead.",
        DeprecationWarning,
        stacklevel=2,
    )
