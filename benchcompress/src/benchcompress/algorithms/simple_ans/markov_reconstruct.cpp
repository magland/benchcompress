...
py::array_t<int16_t> markov_reconstruct_cpp(py::array_t<float> coeffs,
  ...
  for (size_t i = 0; i < resid_size; i++) {
    ...
    int16_t final_value = static_cast<int16_t>(
        rounded_prediction + static_cast<float>(resid_ptr[i]));
